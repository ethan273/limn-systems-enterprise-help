...
5. If valid to Create session, redirect to /dashboard
6. If invalid to Sign out, show error message
```
...
4. Matches email to Assigns user_type and role automatically
